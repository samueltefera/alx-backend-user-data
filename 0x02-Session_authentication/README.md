...
This repo is included in Specializations - Web Stack programming ― Back-end Course of Holberton School. We will cover the `Session authentication` concept for backend folder.
...
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/f_5WublHyx8G6SwifdriBg "explain to anyone"), **without the help of Google**:
...
Copy all your work of the [0x01. Basic authentication](https://intranet.hbtn.io/rltoken/tUmo1sDyeyKisCMqoWe-Pw "0x01. Basic authentication") project in this new folder.
